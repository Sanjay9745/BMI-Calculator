  ...
  return (
    ...
    <div className="text-center shadow-sm rounded">
      <ul className="list-group">
        ...
        <li className={18.5 < bmi && bmi <24.9 ?"border border-success border-3 list-group-item":"list-group-item"}>
          <div className="row">
        ...
        <li className={29.9 < bmi && bmi <34.9 ?"border border-danger border-3 list-group-item":"list-group-item"}>
          <div className="row">
            ...
            <div className="col-4 ">{range.obesityOne.low + "kg - " + range.obesityOne.high}</div>
          </div>
        </li>
        <li className={34.9 < bmi && bmi <39.9 ?"border border-danger border-3 list-group-item":"list-group-item"}>
          <div className="row">
            ...
            <div className="col-4 ">{range.obesityTwo.low + "kg - " + range.obesityTwo.high}</div>
          </div>
        </li>
        
        <li className={39.9< bmi  ?"border border-danger border-3 list-group-item":"list-group-item"}>
          <div className="row">
            <div className="col-4 ">Obesity Class III</div>
            <div className="col-4 ">&gt;40</div>
            <div className="col-4 ">&gt;{range.obesityThree.high}</div>
          </div>
        </li>
